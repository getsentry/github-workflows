...
function Sort([Parameter(Mandatory = $true)][string[]] $List)
{
...
RunTest "sort standard versions" {
    $sorted = Sort @('3.0.0', '5.4.11', 'v1.2.3', '5.4.1')
    AssertEqual @('v1.2.3', '3.0.0', '5.4.1', '5.4.11') $sorted
}

RunTest "sort standard versions v2" {
    $sorted = Sort @('3.0.0', 'v6.0', '5.4.11', '5.5', 'v1.2.3', '5.4.1')
...
#     $sorted = Sort @('3.0.0', '5.4.11', 'v1.2.3', '5.4.1', '5.4.11-rc.0')
